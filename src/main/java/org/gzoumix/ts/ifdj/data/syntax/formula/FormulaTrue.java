...
public class FormulaTrue extends ASTNodeCommonFunctionalities<IASTNode> implements IFormulaElement  {

  public FormulaTrue(Position pos) { super(pos); }
  public FormulaTrue() { this(Reference.DUMMY_POSITION); }
