package org.gzoumix.ifdj.lang.parser;
/******************************************************************************/
...
public class ProgramFactory {
  ...
  /**
   * creates a IFDJ program from a set of input files
   * @param fileNames the list of source files
   * @return the IFDJ program resulting of parsing all the source files
   */
